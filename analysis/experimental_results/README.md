This directory contains the experimental results from our benchmark, obtained as described in [the experiments directory](https://github.com/DrCohomology/EncoderBenchmarking/tree/main/src).
