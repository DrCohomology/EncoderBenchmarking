...
experiment_name = "DT_RF_noise_10k10k"
...
def main_loop(dataset, encoders, index, resample_states):
    ...
    encoders_name = tuple(encoder.__name__ for encoder in encoders)
    outs = []
    ...
    for resample_num, random_state in enumerate(resample_states):
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X, y, test_size=test_size, random_state=1444, stratify=y
        )
